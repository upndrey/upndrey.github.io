...
if(window.screen.width > 900) {
    !function (e, o) {
        ...
        var a = "fullpage-wrapper", l = "." + a, s = "fp-responsive", r = "fp-notransition", c = "fp-destroyed",
            ...
            g = "fp-section", m = "." + g, w = m + h, S = m + ":first", b = m + ":last", x = "fp-tableCell",
            y = "." + x, C = "fp-auto-height", T = "fp-normal-scroll", k = "fp-nav", L = "#" + k, A = "fp-tooltip",
            O = "." + A, I = "fp-show-active", E = "fp-slide", M = "." + E, B = M + h, R = "fp-slides", z = "." + R,
        ...
        e.fn.fullpage = function (j) {
            if (e("html").hasClass(d)) $o(); else {
                ...
                var $, ee, oe, ne, te = !1,
                    ...
                    le = e(this), se = Q.height(), re = !1, ce = !0, de = !0, fe = [],
