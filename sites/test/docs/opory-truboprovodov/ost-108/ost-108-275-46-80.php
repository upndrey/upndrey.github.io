...
<div class="content">
    ...
    <div class="box_center">
        ...
        <div id="scan_img_doc_new">
            <div class="scan_img"><img src="../../../docs/skan/opory-truboprovodov/108-275-80/ost-108-275-46-80/1.png"
                                       title="��� 108.275.46-80. �������� 1" alt="��� 108.275.46-80. �������� 1"/><a
                        href="ost-108-275-46-80.php#" onclick="go_to_top(); return false;">������</a>
                <span>�������� 1</span></div>
            <div class="scan_img"><img src="../../../docs/skan/opory-truboprovodov/108-275-80/ost-108-275-46-80/2.png"
                                       title="��� 108.275.46-80. �������� 2" alt="��� 108.275.46-80. �������� 2"/><a
                        href="ost-108-275-46-80.php#" onclick="go_to_top(); return false;">������</a>
                <span>�������� 2</span></div>
        </div>

        <div class="link-fon-file">
            <p><a href="http://www.szzmk.ru/docs/opory-truboprovodov/108-275-80/OST_108-275-46-80.pdf" target="_blank">�������
                    ��� 108.275.46-80: ����� ������� ������������� ��� ���� ������������� ��� � ���</a></p>
        </div>
    </div>
