...
<div class="content">
    ...
    <div class="box_center"><h1>����� 3.017-3 ������ 2: ���������� �������� � �������� �����������, ������ �
            ����������</h1>
        ...
        <div id="scan_img_doc_new">
            <div class="scan_img"><img
                        src="../../docs/skan/lestnicy-ograzhdeniya/seriya-3-017-3/seriya-3-017-3-v2/1.png"
                        title="����� 3.017-3 ������ 2. �������� 1" alt="����� 3.017-3 ������ 2. �������� 1"/><a
                        href="seriya-3-017-3-vypusk-2.php#" onclick="go_to_top(); return false;">������</a> <span>�������� 1</span>
            </div>
            <div class="scan_img"><img
                        src="../../docs/skan/lestnicy-ograzhdeniya/seriya-3-017-3/seriya-3-017-3-v2/2.png"
                        title="����� 3.017-3 ������ 2. �������� 2" alt="����� 3.017-3 ������ 2. �������� 2"/><a
                        href="seriya-3-017-3-vypusk-2.php#" onclick="go_to_top(); return false;">������</a> <span>�������� 2</span>
            </div>
            <div class="scan_img"><img
                        src="../../docs/skan/lestnicy-ograzhdeniya/seriya-3-017-3/seriya-3-017-3-v2/3.png"
                        title="����� 3.017-3 ������ 2. �������� 3" alt="����� 3.017-3 ������ 2. �������� 3"/><a
                        href="seriya-3-017-3-vypusk-2.php#" onclick="go_to_top(); return false;">������</a> <span>�������� 3</span>
            </div>
            <div class="scan_img"><img
                        src="../../docs/skan/lestnicy-ograzhdeniya/seriya-3-017-3/seriya-3-017-3-v2/4.png"
                        title="����� 3.017-3 ������ 2. �������� 4" alt="����� 3.017-3 ������ 2. �������� 4"/><a
                        href="seriya-3-017-3-vypusk-2.php#" onclick="go_to_top(); return false;">������</a> <span>�������� 4</span>
            </div>
            <div class="scan_img"><img
                        src="../../docs/skan/lestnicy-ograzhdeniya/seriya-3-017-3/seriya-3-017-3-v2/5.png"
                        title="����� 3.017-3 ������ 2. �������� 5" alt="����� 3.017-3 ������ 2. �������� 5"/><a
                        href="seriya-3-017-3-vypusk-2.php#" onclick="go_to_top(); return false;">������</a> <span>�������� 5</span>
            </div>
            <div class="scan_img"><img
                        src="../../docs/skan/lestnicy-ograzhdeniya/seriya-3-017-3/seriya-3-017-3-v2/6.png"
                        title="����� 3.017-3 ������ 2. �������� 6" alt="����� 3.017-3 ������ 2. �������� 6"/><a
                        href="seriya-3-017-3-vypusk-2.php#" onclick="go_to_top(); return false;">������</a> <span>�������� 6</span>
            </div>
        </div>
        <div class="link-fon-file">
            <p><a href="http://www.szzmk.ru/docs/lestnicy-ograzhdeniya/seriya-3-017-3/Seriya_3-017-3-v2.pdf"
                  target="_blank">������� ����� 3.017-3 ������ 2: ���������� �������� � �������� �����������, ������ �
                    ����������. ������������� �������� ����������</a></p>
        </div>
    </div>
